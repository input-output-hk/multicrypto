...
import io.iohk.multicrypto.error.CryptoError
...
object DecodeError {
  ...
  /**
    ...
    * supported by the `multicrypto` package
    */
...
object KeyDecodeError {
  ...
  /**
    ...
    */
  case class KeyDecodingError[T](cause: io.iohk.multicrypto.encoding.KeyDecodingError) extends KeyDecodeError[T]
}
